...
namespace GetTheMilkTests.IntegrationTests
{
    ...
    public class AutoPlayTestLevel1
    {
        ...
        //                          level.CurrentMap.FirstOrDefault(m => m.Number == player.MapNumber),
        ...
        //    actionResult = player.TryPerformAction(openDoor,
        ...
        //    movementResult = player.TryPerformMove(run, level.CurrentMap.FirstOrDefault(m => m.Number == player.MapNumber),
        //                                           level.Objects.Objects, level.Characters.Characters);
        ...
        //    movementResult = player.TryPerformMove(run, level.CurrentMap[0], level.Objects.Objects, level.Characters.Characters);
